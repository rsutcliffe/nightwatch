...
47. A first launch with no settings opens "Welcome to Nightwatch": choosing a telescope sets the field of view; "Use this Mac's location" asks macOS for permission; "Add a site…" opens the sheet; "Start watching" closes it and it never returns. Existing users never see it. → pass.
