...
**First launch.** A welcome window asks what you image with (the telescope presets, or something else) and where you observe from ("Use this Mac's location", which is when macOS asks for permission, or "Add a site…"), then "Start watching". Existing settings skip it.
